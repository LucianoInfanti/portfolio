    ...
    <div className="article-container">
      ...
      <div className="article-content-container">
        <ArticleTitle
          title={
            <>
              Not every ideia is a <em className="title-italic">hypothesis</em>
            </>
          }
        ...
        <p className="article-body">
          ...
          <a href="https://www.reddit.com/r/sveltejs/" className="article-link">
            /r/Svelte
          </a>{" "}
          community on Reddit is incredible newbie-friendly. I wasn't expecting
          to be so well received. That was a nice surprise for sure.
        </p>
